...
public class Exercise16Employee {
	...
	public Exercise16Employee() {
		
	}
	
	public Exercise16Employee(String name, double coefficientsSalary, int numberOfFamily, double allowance) {
		this.name = name;

...
public class Exercise17Handling {
	...
	public static void main(String[] args) {
		...
		try {
			Exercise17CD[] cds = new Exercise17CD[1];
			Exercise17ManagementCDs managementCDs = new Exercise17ManagementCDs();
			...
			for (int i = 0; i < cds.length; i++) {
				...
				cds[i] = new Exercise17CD(id, name, singer, numOfSongs, price);

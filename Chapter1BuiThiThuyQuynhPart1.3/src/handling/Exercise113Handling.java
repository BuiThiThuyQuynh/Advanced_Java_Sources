...
import classes.Exercise113BusinessEmployee;
import classes.Exercise113ManagementEmployee;
import classes.Exercise113ProductionEmployee;

public class Exercise113Handling {

	public static void main(String[] args) {
		
		BufferedReader input = new BufferedReader(new InputStreamReader(System.in));
		
		Exercise113BusinessEmployee[] listBusinessEmployee = new Exercise113BusinessEmployee[0];
		Exercise113ProductionEmployee[] listProductionEmployee = new Exercise113ProductionEmployee[0];
		Exercise113ManagementEmployee managementEmployee = new Exercise113ManagementEmployee();
		
		Exercise113BusinessEmployee businessEmployee;
		Exercise113ProductionEmployee productionEmployee;
			...
			while (flag) {
				...
				switch (choose) {
					case 1:
						...
						businessEmployee = new Exercise113BusinessEmployee(name, coefficientsSalary, 
					...
					case 2:
						...
						productionEmployee = new Exercise113ProductionEmployee(name, coefficientsSalary,

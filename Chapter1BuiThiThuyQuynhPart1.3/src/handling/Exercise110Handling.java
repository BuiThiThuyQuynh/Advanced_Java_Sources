...
import classes.Exercise110ManagementHuman;
...
public class Exercise110Handling {
	...
	public static void main(String[] args) {
		...
		Exercise110Teacher[] listTeachers = new Exercise110Teacher[0];
		Exercise110Student[] listStudents = new Exercise110Student[0];
		Exercise110ManagementHuman managementHuman = new Exercise110ManagementHuman();

...
public class SumFeeDesktopJUnitTest {
	...
	public void testSumFeeDesktop3() {
		...
		desktops[0] = new Desktop("001", 1000, "Sony", 14, "Core I3", 8);
	...
	public void testSumFeeDesktop4() {
		desktops =  new Desktop[4];
		desktops[0] = new Desktop("001", 1000, "Sony", 4, "Core I3", 8);
		desktops[1] = new Desktop("001", 2000, "Sony", 3, "Core I3", 8);
		desktops[2] = new Desktop("001", 3000, "Sony", 2, "Core I3", 8);
		desktops[3] = new Desktop("001", 4000, "Sony", 1, "Core I3", 8);
	...
	public void testSumFeeDesktop7() {
		desktops =  new Desktop[1];
		desktops[0] = new Desktop("001", 12000, "Sony", 0, "Core I3", 8);
	...
	public void testSumFeeDesktop8() {
		desktops =  new Desktop[2];
		desktops[0] = new Desktop("001", 12000, "Sony", 14, "Core I3", 8);
		desktops[1] = new Desktop("001", 12000, "Sony", 3, "Core I3", 8);
	...
	public void testSumFeeDesktop10() {
		desktops =  new Desktop[4];
		desktops[0] = new Desktop("001", 1000, "Sony", 1, "Core I3", 8);
		desktops[1] = new Desktop("001", 1000, "Sony", 2, "Core I3", 8);
		desktops[2] = new Desktop("001", 1000, "Sony", 3, "Core I3", 8);
		desktops[3] = new Desktop("001", 1000, "Sony", 4, "Core I3", 8);

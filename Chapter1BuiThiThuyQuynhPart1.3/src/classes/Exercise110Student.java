...
public class Exercise110Student extends Exercise110Human{

	private String studentOfClass;
	private double semester1Score;
	private double semester2Score;
	
	public Exercise110Student() {
		
	}
	
	public Exercise110Student(String name, Date birthDate, String address, String phone,

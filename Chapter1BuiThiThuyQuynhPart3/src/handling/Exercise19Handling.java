...
public class Exercise19Handling {

	public static void main(String[] args) {
		
		BufferedReader input = new BufferedReader(new InputStreamReader(System.in));
		
		Exercise19Laptop[] laptops = new Exercise19Laptop[0];
		Exercise19Desktop[] desktops = new Exercise19Desktop[0];
			...
			while (flag) {
				...
				switch (choose) {
					case 1:
						...
						laptop = new Exercise19Laptop(id, price, manufactory, quantity, 
					...
					case 2:
						...
						desktop = new Exercise19Desktop(id, price, manufactory, quantity,
										cpu, ram);
